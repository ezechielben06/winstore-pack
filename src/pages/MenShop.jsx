// 📄 src/pages/MenShop.jsx - Version améliorée
...
const MenShop = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-masculine-light/30 to-white">
      {/* Bannière avec logo */}
      <div className="relative bg-gradient-to-r from-masculine-primary via-masculine-secondary to-masculine-light py-12 overflow-hidden">
        {/* Décoration */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="bg-white/20 backdrop-blur-sm p-3 rounded-2xl">
                <MenLogo className="w-16 h-16" text={false} />
              </div>
              <div>
                ...
                <p className="text-white/80 text-sm flex items-center gap-2">
                  ...
                  Style, assurance et charisme à chaque pack
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-2xl">
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{menPacks.length}</p>
                <p className="text-xs text-white/70">Packs</p>
              </div>
              <div className="w-px h-10 bg-white/30" />
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{menProducts.length}</p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <Link 
              to="/" 
              className="text-sm text-gray-500 hover:text-masculine-primary transition-colors flex items-center gap-1"
            >
        ...
        <div className="mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Package className="w-5 h-5 text-masculine-primary" />
        ...
        {/* Footer info */}
        <div className="mt-12 p-6 bg-gradient-to-r from-gold/10 to-masculine-light/30 rounded-2xl text-center border border-gold/20">
          ...
          <p className="text-gray-600">
            ...
            en sélectionnant <span className="font-semibold text-masculine-primary">3 articles ou plus</span> 
